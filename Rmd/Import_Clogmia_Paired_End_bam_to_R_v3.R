import.clogmia.pe.v3 = function(file, qualthresh = 10, exclude.duplicates = FALSE)
{
  # this function will import paired-end data that has been mapped and duplicate-marked. It takes as input a path to a .bamfile. It gives the option to set the map-quality score cutoff as well as whether or not to exclude duplicates. This is a more generalized and versatile version of the importer for ATAC seq reads.
  # this function was updated 3-15-2024 to be compatible to the new genome and BSgenome for C. albipunctata (BSgenome.Calbipunctata.Cantata.uni4000)
  # Calbipunctata.Cantata.uni4000 was generated by Cantatabio
  ...
  cat(paste('Running import.clogmia.pe.v3() on',file,'\n\n'))
